...
#ifndef CONFIG_COMPONENTS_AMP_USER_MEMORY
#define AMP_USER_MEMORY_ENTRIES				0
#endif

#define NUM_RESOURCE_ENTRIES	(2 + OPENAMP_APPEND_RESOURCE_ENTRIES + AMP_TRACE_RESOURCE_ENTRIES + AMP_SHARE_IRQ_ENTRIES \
								+ AMP_USER_RESOURCE_ENTRIES + AMP_USER_MEMORY_ENTRIES)
...
#ifdef CONFIG_COMPONENTS_AMP_USER_MEMORY
	AMP_USER_MEMORY_MEMBERS_DEFINITION
#endif
} __attribute__((packed));
