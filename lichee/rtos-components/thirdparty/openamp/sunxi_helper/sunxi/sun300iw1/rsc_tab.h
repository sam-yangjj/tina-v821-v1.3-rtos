#ifndef OPENAMP_SUN300IW1_RSC_TAB_H_
#define OPENAMP_SUN300IW1_RSC_TAB_H_
...
#ifndef CONFIG_COMPONENTS_AMP_USER_RESOURCE
#define AMP_USER_RESOURCE_ENTRIES				0
#endif

#define NUM_RESOURCE_ENTRIES	(2 + OPENAMP_APPEND_RESOURCE_ENTRIES + AMP_TRACE_RESOURCE_ENTRIES + AMP_SHARE_IRQ_ENTRIES + AMP_USER_RESOURCE_ENTRIES)
#define NUM_VRINGS				2
...
#endif
#ifdef CONFIG_COMPONENTS_AMP_USER_RESOURCE
	AMP_USER_RESOURCE_MEMBERS_DEFINITION
#endif
} __attribute__((packed));
...
#endif /* OPENAMP_SUN300IW1_RSC_TAB_H_ */
