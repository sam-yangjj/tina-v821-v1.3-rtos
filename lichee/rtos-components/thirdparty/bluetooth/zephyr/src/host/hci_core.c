...
{
	__attribute__((__unused__)) struct bt_hci_evt_data_buf_overflow *evt = (void *)buf->data;
...
__attribute__((__unused__)) static void hci_reset_complete(struct net_buf *buf) // fix unused-function
{
