...
#define portNetworkInit      mqttNetworkInit
#define portConnectServer    mqttConnectServer
#define portDisconnectServer mqttDisconnectServer
#define portTransportRecv    mqttTransportRecv
#define portTransportSend    mqttTransportSend
