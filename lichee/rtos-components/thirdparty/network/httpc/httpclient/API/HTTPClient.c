        ...
        // Can be used for evaluating a HEAD request
{
        ...
        do
        {
                ...
                else
                {
                        ...
                        memcpy(RequestCmd + pHTTPSession->HttpCounters.nSentHeaderBytes,pHTTPSession->HttpUrl.Url,nBytes);
#endif
                        // Set the counters
                        pHTTPSession->HttpCounters.nSentHeaderBytes += nBytes;
                }
...
UINT32 HTTPIntrnAuthSendDigest (P_HTTP_SESSION pHTTPSession)
{
        ...
        do
        {
                ...
                memcpy(pParam,pHTTPSession->HttpCredentials.CredUser,nbytes);
                tbytes += nbytes;
                pParam += nbytes;
#endif
