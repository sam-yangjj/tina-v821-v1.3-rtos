...
#define LWIP_PBUF_MEMPOOL_PM(name, num, payload, desc) LWIP_MEMPOOL_PM(name, num, (LWIP_MEM_ALIGN_SIZE(sizeof(struct pbuf)) + LWIP_MEM_ALIGN_SIZE(payload)), desc)
#endif
...
#if (defined CONFIG_ARCH_SUN300IW1) && (defined CONFIG_COMPONENTS_PM)
LWIP_MEMPOOL_PM(TCPIP_MSG_INPKT,MEMP_NUM_TCPIP_MSG_INPKT, sizeof(struct tcpip_msg),      "TCPIP_MSG_INPKT")
#else
...
#if (defined CONFIG_ARCH_SUN300IW1) && (defined CONFIG_COMPONENTS_PM)
LWIP_PBUF_MEMPOOL_PM(PBUF_POOL, PBUF_POOL_SIZE,           PBUF_POOL_BUFSIZE,             "PBUF_POOL")
#else
