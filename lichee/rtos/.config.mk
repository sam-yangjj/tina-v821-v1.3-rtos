...
ifeq ($(CONFIG_ARCH_ARM_CORTEX_A55), y)
INCLUDES += -I $(BASE)/kernel/$(CC_KERNEL_VER)/Source/include/ -I $(BASE)/kernel/$(CC_KERNEL_VER)/Source/portable/GCC/ARM_CA53_64_BIT/
INCLUDES += -I $(BASE)/include/arch/arm/armv8a/
INCLUDES += -I $(BASE)/include/arch/arm/mach/
endif
...
ifneq ($(CONFIG_ARCH_SUN55IW6P1), y)
