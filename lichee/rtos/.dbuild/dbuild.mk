...
kconfig-info:
	...
	@echo "For Ubuntu 20+ : sudo apt-get install kconfig-frontends"
...
CHECK_MCONF := $(shell which kconfig-mconf)
CHECK_CONF := $(shell which kconfig-conf)
CONF:=kconfig-conf
MCONF:=kconfig-mconf
MCONF_TERM:=
...
ifneq ($(RTOS_TARGET_PROJECT_PATH),)
	...
	@cd $(BASE)/ && $(MCONF_TERM) CONFIG_=$(CONFIG_) PROJECT_DIR=$(PROJECT_DIR) $(MCONF) Kconfig || \
		{ echo "*** kconfig-frontends was not installed correctly"; $(MAKE) kconfig-info ; false; }
...
ifneq ($(RTOS_TARGET_PROJECT_PATH),)
	...
	@cd $(BASE)/ && $(MCONF_TERM) CONFIG_=$(CONFIG_) PROJECT_DIR=$(PROJECT_DIR) $(MCONF) --olddefconfig Kconfig || \
		{ echo "*** kconfig-frontends was not installed correctly"; $(MAKE) kconfig-info ; false; }
endif
