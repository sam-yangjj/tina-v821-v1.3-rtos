...
static int sensor_power(int id, int on)
{
	...
	case PWR_ON:
		...
		hal_usleep(1000);
		sensor_dbg("Ready to set RESEY PWD_ON!\n");
...
struct sensor_fuc_core f355p_dvp_core  = {
