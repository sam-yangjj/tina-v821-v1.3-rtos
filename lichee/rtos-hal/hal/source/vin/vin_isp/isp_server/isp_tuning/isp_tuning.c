...
int isp_get_ini_tunning_info(struct hw_isp_device *hw_isp, void *dst)
{
	...
	*char_ptr = isp_gen->sensor_info.color_space;
	...
	//ae stat
	memcpy(char_ptr, &isp_gen->stats_ctx.stats.ae_stats, sizeof(struct isp_ae_stats_s));
	char_ptr += sizeof(struct isp_ae_stats_s);
	//awb stat
	memcpy(char_ptr, &isp_gen->stats_ctx.stats.awb_stats, sizeof(struct isp_awb_stats_s));
	char_ptr += sizeof(struct isp_awb_stats_s);
	//d3d k stat
	memcpy(char_ptr, &isp_gen->stats_ctx.stats.d3d_k_stats, sizeof(struct isp_d3d_k_stats_s));
	char_ptr += sizeof(struct isp_d3d_k_stats_s);
