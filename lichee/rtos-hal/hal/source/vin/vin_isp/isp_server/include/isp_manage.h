...
#if (ISP_VERSION == 603)
#define ISP_DEVICE_NUM 2
#else
#define ISP_DEVICE_NUM 4
#endif

#define ISP_FAST_CONVERGENCE_FPS 60
#define ISP_FAST_CONVERGENCE_FRAME 15
#define ISP_FAST_CONVERGENCE_ALGO_FRAME 8
...
/* HFR setting */
#define PLTM_LFT_USE_HFR_STREN 0
#define GTM_LFT_USE_HFR_TBL 0
...
struct local_wb_data_save {
	float gain_r_save[ISP_LENS_TBL_SIZE];
	float gain_b_save[ISP_LENS_TBL_SIZE];
	unsigned short tbl_save[ISP_LENS_TBL_SIZE * 4];
	float gain_max;
};
...
struct isp_lib_context {
	...
	unsigned short ae_ev_idx_status;
