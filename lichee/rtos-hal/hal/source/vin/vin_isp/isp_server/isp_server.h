...
#define ISP_RPBUF_TUNNING_LEN (sizeof(struct isp_param_config) + sizeof(HW_U16) + 2*sizeof(HW_U8) + \
						...
						sizeof(struct isp_ae_stats_s) + sizeof(struct isp_awb_stats_s) + sizeof(struct isp_d3d_k_stats_s))
...
struct hw_isp_device {
	...
	hal_work isp_tuning_rpbuf_server_work;
	hal_work isp_save_ae_server_work;
...
#define VIN_ISP_PARAM_RESERVE_SIZE (0x2000)
