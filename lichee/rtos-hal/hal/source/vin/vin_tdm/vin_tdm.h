...
#if (CONFIG_ISP_NUMBER == 2) && defined (CONFIG_ISP_READ_THRESHOLD)
#ifdef CONFIG_TDM_RX_BUF_NUM
#define TDM_RX_BUF_CNT CONFIG_TDM_RX_BUF_NUM
#else
#define TDM_RX_BUF_CNT 1
#endif
#else
#define TDM_RX_BUF_CNT 2
#endif
...
struct tdm_dev {
	...
	hal_workqueue *tdm_dev_run_task;
	hal_work tdm_reset_work;
};
